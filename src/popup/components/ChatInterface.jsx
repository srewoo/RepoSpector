...
export function ChatInterface({ autoGenerateType = null, onBack = null, instanceId = 'popup' }) {
    ...
    useEffect(() => {
        const handleMessage = (message, sender) => {
            ...
            if (message.action === 'TEST_CHUNK' && message.data) {
                ...
                if (isLastChunk) {
                    console.log('✅ Received last chunk, finalizing message');
                    setStreamingPhase('');
            ...
            if (message.action === 'HEARTBEAT') {
                console.log('💓 Received heartbeat from background');
            }
        };
    ...
    useEffect(() => {
        if (autoGenerateType && !autoGenerated) {
            ...
            const generateAuto = async () => {
                ...
                setStreamingPhase('🔍 Extracting code for AI analysis...');
    ...
    const handleSubmit = async (e) => {
        ...
        console.log('📤 New request submitted:', input);
        ...
        try {
            ...
            if (isTestGeneration) {
                ...
                setStreamingPhase('💬 Asking AI about your code...');
            ...
            if (errMsg.includes('timeout')) {
                ...
                errorContent = '💾 Response too large';
